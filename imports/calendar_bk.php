...
class Calendar {  
    ...
    */
    ...
    $conn->close();		
              ...
              $jsDateClick = 'reply_click("li-' . $this->currentDate.'","''")';   
              $toolTip = '';


        return '<li id="li-'.$this->currentDate.'" onclick='.$jsDateClick.' class="'.$cssClass.($cellNumber%7==1?' start ':($cellNumber%7==0?' end ':' ')).
                ($cellContent==null?'mask':'').'" '.$toolTip.'>'.$cellContent."</br>".$dateDetails.'</li>';
  }*/
